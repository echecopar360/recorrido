...
var miModal2  = document.getElementById('miModal')
miModal2.style.display = 'none';

var textoInf  = document.getElementById('textoInfo')
var titleInf  = document.getElementById('titleInfo')
var btnInf  = document.getElementById('btnInfo')
...
function clickInfo() {    
   PlaySound() ;
    miModal2.style.display = (miModal2.style.display == 'none') ? 'block' : 'none'; 
}
       ...
       // console.log("carga 2")
        ...
        switch ( nameBoton ) {
			case 'btn1':
                //loby
                miModal2.style.display = 'block'; 
                titleInf.innerHTML  = "LOBBY:"
                textoInf.innerHTML  = "El lobby estará ubicado en el piso 7 donde estará nuestro client center. <br>Este piso contará con 9 salas de reunión exclusiva para clientes y 1 sala de innovación. Además tendrá 3 zonas de espera y un videowall para la comunicación de la firma.";
			...
			case 'btn2':
                //loby
                 miModal2.style.display = 'block'; 
                titleInf.innerHTML  = "MESA DE PARTES:"
                textoInf.innerHTML = "La mesa de partes estará ubicada en el piso 6 del edificio, compartiendo la planta con la Sala B-Green. Será un espacio amplio, moderno y acogedor que permita una gestión eficiente, correcta y ordenada para la recepción y entrega de documentos.";                
			...
			case 'btn3':
                 ...
                 miModal2.style.display = 'block'; 
                titleInf.innerHTML  = "SALA B-GREEN:"
                textoInf.innerHTML = "Es el espacio informal para los colaboradores. El nombre viene del proyecto creado en Baker Mckenzie en el 2015, para incorporar la sostenibilidad y la responsabilidad con el medio ambiente. Será un espacio para comer y distraerse un poco de la rutina diaria.";
			...
			case 'btn4':
                miModal2.style.display = 'block'; 
                titleInf.innerHTML  = "SALA DE INNOVACIÓN:"
                textoInf.innerHTML = "Para hacer cambios, tenemos que pensar distinto y los espacios ayudan a hacerlo. Junto con nuestro comité de innovación, creamos un ambiente lúdico para desarrollar nuevas ideas y proyectos. Cuenta con pizarra portátil táctil y pizarras acrílicas en las paredes.";
            ...
            case 'btn5':
                 ...
                 miModal2.style.display = 'block'; 
                titleInf.innerHTML  = "SALAS DE REUNIÓN:"
                textoInf.innerHTML = "Nuestras salas de reunión para clientes tendrán el espacio y la tecnología necesaria para las reuniones con ellos. Contarán con un aforo para 8 a 16 personas en promedio. Asimismo tendrán dispositivos para presentaciones y videoconferencias.";
